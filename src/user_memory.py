...
class UserMemory(DynamicMemory):
    ...
    def set_entity_concept(self, entity_id, concept):
        """Disabled for user learning: classification must remain explicit IS_A evidence."""
        raise ValueError("UserMemory does not mutate entity concepts; store explicit IS_A evidence instead.")
